...
# attraction, admission, setting and region's data type is character; n_2021,n_2022: double
...
# NA represents there is no value of the varible.
...
**Write your answer here**
# removes missing values from data if they are coded as NA.
...
**Write your answer here**
# for mean values, there are some integers which are extremely high(or low), therefore, the total number maybe very large, so the mean of the list is larger. The defination of median is the middle number in a sorted list of numbers. 
